...
namespace StarterAssets
{
    ...
    public class ThirdPersonControllerARPG : MonoBehaviour
    {
        ...
        [SerializeField]
        private bool _estaEnGuardia;
        public bool estaEnGuardia
        {
            get { return _estaEnGuardia; }
            set
            {
                if (value != _estaEnGuardia)
                {
                    _estaEnGuardia = value;

                    eventoEnGuardia.Invoke(_estaEnGuardia);
                }
            }
        }
        ...
        {
            if(estaAgachado == false && Grounded == true)
            {
                estaEnGuardia = true;
        ...
        {
            if (Grounded == true && estaEnGuardia == false)// && _animator.GetBool("FreeFall") == false)
            {
        ...
        private void Move()
        {
            ...
            if (_hasAnimator)
            {
                ...
                {
                    _animator.SetFloat("velocidadAdelante", _input.move.y);
                    _animator.SetFloat("velocidadDerecha", _input.move.x);
                }
            }
        }
        
        private void MoveARPG()
        {
            // set target speed based on move speed, sprint speed and if sprint is pressed
            float targetSpeed = _input.sprint ? SprintSpeed : MoveSpeed;
        ...
        {
            if (Grounded == true && estaAgachado == false && estaEnGuardia == false)
            {
